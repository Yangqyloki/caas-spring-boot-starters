...
public class HeuristicCompletionExceptionConverterTest
{
	private static final String TEST_MESSAGE = "test message";

	private final HeuristicCompletionExceptionConverter converter = new HeuristicCompletionExceptionConverter(
	...
	{
		final HeuristicCompletionException exception = new HeuristicCompletionException(0,
				new TransactionSystemException(TEST_MESSAGE));
	...
	{
		final HeuristicCompletionException exception = new HeuristicCompletionException(0,
				new TransactionSystemException(TEST_MESSAGE, DatabaseException.sqlException(new PSQLException(null, null))));
	...
	{
		final HeuristicCompletionException exception = new HeuristicCompletionException(0, new TransactionSystemException(TEST_MESSAGE,
	...
	{
		final HeuristicCompletionException exception = new HeuristicCompletionException(0, new TransactionSystemException(TEST_MESSAGE,
				DatabaseException.sqlException(new PSQLException(
						"ERROR: insert or update on table \"my_table\" violates foreign key constraint \"my_table_fkey\"", null))));
